...
void astToSourceCode(FILE* file, AST* node, int level, int firstParamOrArg){
	if(node != NULL){
		...
		switch(node->type){
			...
			case AST_FOR : break;
			case AST_VECTINIT : break;
			case AST_LSTLIT : break;
