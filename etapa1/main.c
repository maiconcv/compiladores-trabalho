int main(){
	...
	while(running){
		...
		switch(tok){
			...
			case TK_IDENTIFIER: fprintf(stderr, "Line %d: Identifier.\n", lineno); break;
			case LIT_INTEGER: fprintf(stderr, "Line %d: Literal Integer.\n", lineno); break;
			case LIT_FLOAT: fprintf(stderr, "Line %d: Literal Float.\n", lineno); break;
			case LIT_TRUE: fprintf(stderr, "Line %d: Literal True.\n", lineno); break;
			case LIT_FALSE: fprintf(stderr, "Line %d: Literal False.\n", lineno); break;
			case LIT_CHAR: fprintf(stderr, "Line %d: Literal Char.\n", lineno); break;
			case LIT_STRING: fprintf(stderr, "Line %d: Literal String.\n", lineno); break;
			case TOKEN_ERROR: fprintf(stderr, "Line %d: Token error.\n", lineno); break;
